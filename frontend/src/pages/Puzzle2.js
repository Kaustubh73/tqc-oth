...
function Puzzle1() {
    ...
    return ( 
        <div>
            ...
            <h2>What's shaking, ______?!</h2>
            <img src={puzzle2} alt='Puzzle 2'/>
            {message && <p>{message}</p>}
            {solved ? (<p className='right-message'> You have already solved this puzzle. The answer is PRIDE.</p>) : (submitted && isCorrect ? (<p className='right-message'>Congratulations, the answer was PRIDE indeed. Do you understand how it works?</p>)
            :
            (
